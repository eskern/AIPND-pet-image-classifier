...
def print_results(results_dic, results_stats_dic, model,
    ...
    print('% Correct Dogs: ' + str(results_stats_dic['pct_correct_dogs']) + "%")
    print('% Correct "Not-a" Dog: ' + str(results_stats_dic['pct_correct_notdogs']) + "%")
    print('% Correct Breed: ' + str(results_stats_dic['pct_correct_breed']) + "%")
    print('% Matches: ' + str(results_stats_dic['pct_match']) + "%")

    if print_incorrect_dogs and \
    (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']):
        for key in results_dic:
            if sum(results_dic[key][3:]) == 1:
                print(model + ' misclassified dog: ' + key)
